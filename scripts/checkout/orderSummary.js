...
export function renderOrderSummary(){
  ...
  function deliveryOptionsHTML(matchingProduct, cartItem){
    ...
    deliveryOptions.forEach((deliveryOption) => {
      ...
      html += `
      <div class="delivery-option js-delivery-option js-product-id-${matchingProduct.id}-delivery-option-id-${deliveryOption.id}" data-product-id="${matchingProduct.id}" data-delivery-option-id="${deliveryOption.id}">
            <input type="radio" ${isChecked ? 'checked' : ''}
              class="delivery-option-input js-input-product-id-${matchingProduct.id}-delivery-option-id-${deliveryOption.id}"
